...
public class AmazonAwsSQSConnector extends AbstractSQSConnector {
	...
	public AmazonAwsSQSConnector(String awsAccessKey, String awsSecretKey, boolean isSecure,
		...
		this(new BasicAWSCredentials(awsAccessKey, awsSecretKey), isSecure, receiveCheckIntervalMs, false);
	}

	public AmazonAwsSQSConnector(AWSCredentials awsCredentials, boolean isSecure, long receiveCheckIntervalMs,
			boolean isAsync) {
	...
	public String subscribe(NevadoTopic topic, NevadoQueue topicEndpoint) throws JMSException {
		...
		try {
			...
			subscriptionArn = _amazonSNS.subscribe(
